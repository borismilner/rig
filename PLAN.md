...
**The specification is 8878 lines across 39 files and nobody reads it
...
| § | Section | Lines | File |
|---|---|---|---|
| 1 | The idea, in one line | 75 | [`plan/01-the-idea-in-one-line.md`](plan/01-the-idea-in-one-line.md) |
...
| 9 | Built for agents | 271 | [`plan/09-built-for-agents.md`](plan/09-built-for-agents.md) |
| 10 | The terminal client | 135 | [`plan/10-the-terminal-client.md`](plan/10-the-terminal-client.md) |
| 11 | The window | 665 | [`plan/11-the-window.md`](plan/11-the-window.md) |
...
| 22 | Tech stack | 99 | [`plan/22-tech-stack.md`](plan/22-tech-stack.md) |
...
| 28 | Repository, versioning and the Makefile | 89 | [`plan/28-repository-versioning-and-the-makefile.md`](plan/28-repository-versioning-and-the-makefile.md) |
...
| 37 | Two estates, and the gate before rig develops rig | 998 | [`plan/37-two-estates-and-the-gate-before-rig.md`](plan/37-two-estates-and-the-gate-before-rig.md) |
...
| § | Section | Lines | File |
|---|---|---|---|
| 39 | The continuity record | 2500 | [`plan/39-the-continuity-record.md`](plan/39-the-continuity-record.md) |
...
**§31-38 ARE A CHANGELOG INSIDE A SPECIFICATION** - 4212 of 8878 lines,
47%. Splitting the file did not fix that; it made it visible and
