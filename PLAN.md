...
**The specification is 10899 lines across 42 files and nobody reads it
...
| 11 | The window | 1110 | [`plan/11-the-window.md`](plan/11-the-window.md) |
...
| 28 | Repository, versioning and the Makefile | 112 | [`plan/28-repository-versioning-and-the-makefile.md`](plan/28-repository-versioning-and-the-makefile.md) |
...
| 38 | Four standing rules, and none of them is a preference | 147 | [`plan/38-four-standing-rules-and-none-of-them-is.md`](plan/38-four-standing-rules-and-none-of-them-is.md) |

### ADDED SINCE THE SPLIT - specification, not changelog

| § | Section | Lines | File |
|---|---|---|---|
| 39 | The continuity record | 3157 | [`plan/39-the-continuity-record.md`](plan/39-the-continuity-record.md) |
...
| 42 | What an agent is allowed to do | 162 | [`plan/42-what-an-agent-is-allowed-to-do.md`](plan/42-what-an-agent-is-allowed-to-do.md) |
...
**§31-38 ARE A CHANGELOG INSIDE A SPECIFICATION** - 5370 of 10899 lines,
