...
**The specification is 6932 lines across 39 files and nobody reads it
...
| § | Section | Lines | File |
|---|---|---|---|
| 1 | The idea, in one line | 56 | [`plan/01-the-idea-in-one-line.md`](plan/01-the-idea-in-one-line.md) |
...
| § | Section | Lines | File |
|---|---|---|---|
| 5 | Architecture | 856 | [`plan/05-architecture.md`](plan/05-architecture.md) |
...
| 11 | The window | 188 | [`plan/11-the-window.md`](plan/11-the-window.md) |
...
**§31-38 ARE A CHANGELOG INSIDE A SPECIFICATION** - 2849 of 6932 lines,
41%. Splitting the file did not fix that; it made it visible and
