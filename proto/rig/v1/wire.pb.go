...
//
// ⛔ rig.v1 IS THREE FILES AND ONE PROTO PACKAGE, split by door for footprint.
// This file is the program door: the frame, the handshake, the declaration,
// ping and call - all a program links. registry.proto (Go package
// registryv1) is what the window reads; verbs.proto (verbsv1) is rig's own
// verbs, which no program links. Every message keeps its full name, its
// field numbers and its bytes on the wire; wire_golden_test.go pins all of
// them. Measured at the split: every program binary about 270 KB smaller,
// the window about 240 KB.
...
const file_proto_rig_v1_wire_proto_rawDesc = "" +
	...
	"\fTRISTATE_YES\x10\x02B/Z-github.com/borismilner/rig/proto/rig/v1;rigv1b\x06proto3"
